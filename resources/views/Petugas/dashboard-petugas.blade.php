...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .stat-num   { font-size: 24px; font-weight: 600; color: #1a1008; }
  .stat-label { font-size: 12px; color: #6b5630; margin-top: 2px; }
  .stat-sub   { font-size: 10px; color: #c8a84b; margin-top: 4px; }
  ...
  .panel-title { font-size: 13px; font-weight: 600; color: #2c1f0a; }
  .btn-sm {
    font-size: 11px;
    color: #c8a84b;
    background: #fef9ee;
  ...
  .task-name { font-weight: 600; color: #2c1f0a; font-size: 11px; }
  .task-sub  { color: #8b6f3a; font-size: 10px; margin-top: 1px; }
  ...
  .overdue { color: #dc2626; font-size: 10px; font-weight: 600; }
  .ontime  { color: #059669; font-size: 10px; font-weight: 600; }
  .pending { color: #92400e; font-size: 10px; }
  ...
  .log-icon.ok   { background: #d1fae5; color: #047857; }
  .log-icon.info { background: #dbeafe; color: #1d4ed8; }
  .log-icon.warn { background: #fef3c7; color: #b45309; }
  .log-icon.red  { background: #fee2e2; color: #991b1b; }
  .log-text  { flex: 1; }
  .log-title { font-weight: 600; color: #2c1f0a; font-size: 11px; margin-bottom: 2px; }
  .log-desc  { color: #8b6f3a; font-size: 10px; line-height: 1.4; }
  .log-time  { color: #b0956a; font-size: 10px; white-space: nowrap; }
  ...
  .legend-val { font-weight: 600; margin-left: auto; }
  .legend-pct { color: #8b6f3a; margin-left: 4px; font-size: 10px; }
  ...
  .notif-item i { font-size: 15px; flex-shrink: 0; }
  .notif-item.red-n    { background: #fff5f5; }
  .notif-item.amber-n  { background: #fffbeb; }
  .notif-item.yellow-n { background: #fffde7; }
  .notif-item.blue-n   { background: #f0f9ff; }
</style>
</head>
<body>
  ...
  <div class="two-col">
    ...
    <div class="panel">
      ...
      <div class="task-row">
        ...
        <span class="badge badge-red"><i class="ti ti-arrow-back-up" style="font-size:9px"></i> Pengembalian</span>
      ...
      <div class="task-row">
        ...
        <span class="badge badge-blue"><i class="ti ti-arrow-back-up" style="font-size:9px"></i> Pengembalian</span>
    ...
    <div class="panel">
      ...
      <div class="donut-wrap">
        <svg width="100" height="100" viewBox="0 0 100 100">
          ...
          <text x="50" y="60" text-anchor="middle" font-size="18" font-weight="700" fill="#2c1f0a">78</text>
