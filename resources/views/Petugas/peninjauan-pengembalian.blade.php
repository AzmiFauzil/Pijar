...
<head>
    ...
    <title>PIJAR — Meninjau Pengembalian</title>
    ...
    * {
    ...
    .detail-panel {
        ...
        overflow: hidden;
        background: #fff;
        border-left: 0.5px solid #e0d5c0;
...
<body>
    ...
    <div class="content-wrap">
        <div class="main">
            <div class="page-title">Meninjau Pengembalian</div>
            ...
            <div class="stat-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-sub green">Telah dikembalikan hari ini</div>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon danger"><i class="ti ti-alert-triangle"></i></div>
                    <div class="stat-info">
                        <div class="stat-num">2</div>
                        <div class="stat-label">Terlambat</div>
                        <div class="stat-sub red">Melewati tanggal kembali</div>
                    </div>
                </div>
            </div>
            ...
            <!-- Table -->
            <div class="table-title">Daftar Pengajuan Pengembalian</div>
            <div class="panel">
                <table>
                    <thead>
                        <tr>
        ...
        <div class="detail-panel" id="detailPanel">
            ...
            <div class="detail-section">
                ...
                <div class="detail-row"><span class="detail-key">Nama Alat</span><span class="detail-val">Proyektor BenQ
                        M550</span></div>
                <div class="detail-row"><span class="detail-key">ID Barang</span><span class="detail-val">PA-001</span>
                </div>
                <div class="detail-row"><span class="detail-key">Kategori</span><span
                        class="detail-val">Proyektor</span></div>
            </div>

            <div class="detail-section">
                <div class="section-label"><i class="ti ti-user"></i> Informasi Peminjam</div>
                <div class="detail-row"><span class="detail-key">Nama</span><span class="detail-val">Aulia Rahma</span>
                </div>
                <div class="detail-row"><span class="detail-key">Kelas</span><span class="detail-val">XI PPLG</span>
                </div>
                <div class="detail-row"><span class="detail-key">Keperluan</span><span
                        class="detail-val">Presentasi</span></div>
                <div class="detail-row"><span class="detail-key">No. HP</span><span
                        class="detail-val">0812-3456-7890</span></div>
            </div>

            <div class="detail-section">
                <div class="section-label"><i class="ti ti-calendar"></i> Informasi Peminjaman</div>
                <div class="detail-row"><span class="detail-key">Tanggal Pinjam</span><span class="detail-val">03 Mei
                        2026</span></div>
                <div class="detail-row"><span class="detail-key">Tanggal Kembali</span><span class="detail-val">03 Mei
                        2026</span></div>
                <div class="detail-row"><span class="detail-key">Jam Pinjam</span><span class="detail-val">09.30</span>
                </div>
                <div class="detail-row"><span class="detail-key">Jam Kembali</span><span class="detail-val">15.10</span>
                </div>
            ...
            <div class="action-buttons">
                <button class="btn-confirm"><i class="ti ti-check"></i> Konfirmasi Pengembalian</button>
            </div>
        </div>
    </div>
    ...
    function badgeHtml(status) {
        ...
        if (status === 'Dikembalikan') return `<span class="badge badge-green">${status}</span>`;
        if (status === 'Terlambat') return `<span class="badge badge-red">${status}</span>`;
